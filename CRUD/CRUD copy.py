...
def Cadastro_usuario(username, password):
    usuarios=[]
    arquivo_cadastrotxt= open ("crud\cadastrotxt", "r")
    ...
    if username in usuarios:
        ...
        cadastrar=  open ("crud\cadastrotxt", "a")
        cadastrar.write(f"{username},{password}\n")
        cadastrar.close()
...
def Login_usuario(username, password):
    with open("crud\cadastrotxt", "r") as login:
        for linha in login:
            userlog,senhalog=linha.split(",")
            if username==userlog and password== senhalog:
